...
function transform(components, options) {
  ...
  components.forEach((component) => {
    // In case, we don't want to show the component in the styleguide, set the render to false
    if (component.config.render === false) {
      return;
    }
